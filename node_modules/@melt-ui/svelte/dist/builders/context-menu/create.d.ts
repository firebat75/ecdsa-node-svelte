...
export declare function createContextMenu(props?: CreateContextMenuProps): {
    ...
    elements: {
        menu: import("../../internal/helpers/index.js").MeltElement<[Readable<boolean>, WithGet<import("svelte/store").Writable<string | HTMLElement | null | undefined>>, WithGet<import("svelte/store").Writable<string>>, WithGet<import("svelte/store").Writable<string>>], (node: HTMLElement) => MeltActionReturn<ContextMenuEvents['menu']>, ([$isVisible, $portal, $menuId, $triggerId]: [boolean, string | HTMLElement | null | undefined, string, string]) => {
            readonly role: "menu";
    ...
    builders: {
        createSubmenu: (args?: import("../menu/types.js")._CreateSubmenuProps | undefined) => {
            ...
            elements: {
                ...
                subMenu: import("../../internal/helpers/index.js").MeltElement<[Readable<boolean>, WithGet<import("svelte/store").Writable<string>>, WithGet<import("svelte/store").Writable<string>>], (node: HTMLElement) => MeltActionReturn<"focusout" | "keydown" | "pointermove">, ([$subIsVisible, $subMenuId, $subTriggerId]: [boolean, string, string]) => {
                    readonly role: "menu";
                    readonly hidden: true | undefined;
                    readonly style: string;
                    readonly id: string;
