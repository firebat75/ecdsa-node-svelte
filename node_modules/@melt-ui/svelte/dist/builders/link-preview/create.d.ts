...
export declare function createLinkPreview(props?: CreateLinkPreviewProps): {
    ...
    elements: {
        ...
        content: import("../../internal/helpers/index.js").MeltElement<[Readable<boolean>, WithGet<import("svelte/store").Writable<string | HTMLElement | null>>, WithGet<import("svelte/store").Writable<string>>], (node: HTMLElement) => MeltActionReturn<LinkPreviewEvents['content']>, ([$isVisible, $portal, $contentId]: [boolean, string | HTMLElement | null, string]) => {
