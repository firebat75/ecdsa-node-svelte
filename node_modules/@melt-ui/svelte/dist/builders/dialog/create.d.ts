...
export declare function createDialog(props?: CreateDialogProps): {
    ...
    elements: {
        ...
        portalled: import("../../internal/helpers/index.js").MeltElement<import("../../internal/helpers/withGet.js").WithGet<import("svelte/store").Writable<string | HTMLElement | null>>, <Node_2 extends any>(node: HTMLElement) => {
            destroy(): void;
